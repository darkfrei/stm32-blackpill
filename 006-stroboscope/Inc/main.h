...
/**
  ...
  *   PA3  -- EXTI3     (top button -- cycle parameter)
  *   PA4  -- EXTI4     (bottom button -- strobe on/off / hold = reset)
...
#define BTN2_Pin                GPIO_PIN_3      /* top button -- cycle parameter            */
#define BTN2_GPIO_Port          GPIOA
#define BTN2_EXTI_IRQn          EXTI3_IRQn
#define BTN3_Pin                GPIO_PIN_4      /* bottom button -- strobe on/off           */

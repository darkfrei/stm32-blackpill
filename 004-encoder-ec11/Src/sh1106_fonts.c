...
/* ========================================================================
 * FONT 8H - MONOSPACE 8x8 PIXEL FONT
 * ======================================================================== */

#ifdef SH1106_INCLUDE_FONT_8H

/**
 * @brief Font data for 8H monospace font (8x8 pixels)
 * Characters 32-126 (95 characters)
 * Organization: Each character is 8 bytes (8 columns)
 * Each byte represents one column, bits 0-7 are pixels from top to bottom
 */
...
/**
 * @brief Font_8H definition - Monospace 8x8 pixel font
 */
const SH1106_Font_t Font_8H = {
    .width = 8,              // Fixed width 8 pixels
    .height = 8,             // Fixed height 8 pixels
    .data = Font8H_data,    // Font data
    .char_width = NULL       // NULL = monospace (use .width for all chars)
};
...
// Font implementations for 6x8, 7x10, 11x18 would go here
// These are typically monospace fonts, so char_width would be NULL
